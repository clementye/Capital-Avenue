...
{
    public class Card : Case
    {
        string CardType { get; set; }
        public Pawn CLPawn { get; private set; }
        public Player CLPlayer { get; private set; }

        public Card(int index, string name, string cardType) : base(index, name)
        {
            this.Name = name;
            this.Index = index;
        ...
        public string RandomCard(Pawn pawn) //Faudra remplacer les magic numbers par deux liste, une pour la position des chances, et une autre pour l'autre cas. Cela simplifiera le tout.
